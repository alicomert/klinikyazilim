    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6 card-shadow">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="flex items-center space-x-3">
                    <select wire:model.live="procedureFilter" class="border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                        <option value="all">Tüm Prosedürler</option>
                        <option value="burun">Burun Estetiği</option>
                        <option value="botoks">Botoks</option>
                        <option value="dolgu">Dudak Dolgusu</option>
                        <option value="germe">Yüz Germe</option>
                    </select>
                    ...
                    @forelse($patients as $patient)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td x-show="columns.registrationPeriod" class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $patient->registration_period ?? '08.2025' }}</div>
                            </td>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-4 text-sm text-blue-100">
                                    ...
                                    <span class="flex items-center"><i class="fas fa-calendar-alt mr-2"></i>{{ $selectedPatient->registration_period ?? '08.2025' }}</span>
