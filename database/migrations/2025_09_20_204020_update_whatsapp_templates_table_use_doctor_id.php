...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement('UPDATE whatsapp_templates SET doctor_id = user_id WHERE user_id IS NOT NULL');
    ...
    public function down(): void
    {
        Schema::table('whatsapp_templates', function (Blueprint $table) {
            ...
            DB::statement('UPDATE whatsapp_templates SET user_id = doctor_id WHERE doctor_id IS NOT NULL');
